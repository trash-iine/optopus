...
| `LocalRepair<P: Ruinable>` | `AdaptiveLargeNeighborhoodSearch`, optionally | `fn repair_around(&mut self, prob: &P, partial: &mut P::Partial, anchors: &[P::Element], rng: &mut SmallRng)` |
