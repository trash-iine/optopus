...
| LinKernighanHelsgott (TSP) | [lin_kernighan_helsgott.md](lin_kernighan_helsgott.md) |
...
- **Run configs**: TOMLs under `data/benchmarks/<problem>/{general,lkh}_{small,medium,large}.toml`
  are generated by `data/scripts/gen_benchmark_configs.py` from those profiles.
...
machine; see `data/scripts/run_small_band.sh` and `run_medium_band.sh`.
