...
/// Ruin-and-recreate without this is worse on VRP, since greedy re-insertion
/// puts each customer where it is cheapest at the time and never repairs the
/// edges that choice spoils. The cost of leaving it out grows with the
/// instance, and on the largest it is several percent.
