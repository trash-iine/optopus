...
//! drive. Each of the other modules is one heuristic built on top of it (or,
//! for [`kernelized`], a wrapper around any `Heuristic<MaxCut>`).
...
pub use kernelized::KernelizedSearch;
