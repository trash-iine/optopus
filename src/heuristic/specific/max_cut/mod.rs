...
//! Breakout Local Search round does is a generic heuristic, a
//! [`LocalSearch`](crate::heuristic::LocalSearch) descent, a
//! [`RandomWalk`](crate::heuristic::RandomWalk) strong kick and a
//! [`TabuSearch`](crate::heuristic::TabuSearch) weak flip, all sharing the
//! tabu memory of the `SearchState` they are handed. What stays here is the
//! wiring, [`bls_for_max_cut`], the same shape `alns_for_vrp` and
//! `alns_for_tsp` have on their sides.
//!
