...
Usage: python3 data/benchmarks/scripts/gen_benchmark_configs.py
"""
...
def general_toml(problem: str, band: str) -> str:
    parts = [f"# Auto-generated by data/benchmarks/scripts/gen_benchmark_configs.py — do not edit by hand.",
